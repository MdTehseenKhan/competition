          ...
          <div className="container px-5 py-20 mx-auto">
            ...
            <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
              <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
                ...
                <p className="leading-relaxed text-base">
                  ...
                  voluptates quisquam iste labore quae voluptatem dolorem veritatis modi necessitatibus voluptate
                  tempora accusantium tempore at facere architecto eos?
                </p>
                <a className="mt-3 text-blue-500 inline-flex items-center" href="#ongoing">
                  Learn More
                  <svg
                    fill="none"
                    stroke="currentColor"
            ...
            <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
              ...
              <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
                ...
                <p className="leading-relaxed text-base">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Recusandae, sit quas. Placeat culpa amet
                  totam quod. A veniam, quis, praesentium, aut quasi placeat corrupti nesciunt qui tenetur reiciendis
                  quae! Nemo.
                </p>
                <a className="mt-3 text-blue-500 inline-flex items-center" href="#past">
                  Learn More
                  <svg
                    fill="none"
                    stroke="currentColor"
            ...
            <div className="flex items-center lg:w-3/5 mx-auto mb-10 sm:flex-row flex-col">
              <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
                ...
                <p className="leading-relaxed text-base">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Illum magni, alias nulla exercitationem
                  autem unde minus? Perferendis, ipsam! Rem praesentium odit dicta odio porro, repudiandae fuga? Error
                  dolorum ut facilis.
                </p>
                <a className="mt-3 text-blue-500 inline-flex items-center" href="#history">
                  Learn More
                  <svg
                    fill="none"
                    stroke="currentColor"
